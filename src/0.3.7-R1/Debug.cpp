...
int &SAMP::Debug::nMode = *(int *)SAMP_ADDROF(0x13BB18);
void *&SAMP::Debug::pFirstEntity = *(void **)SAMP_ADDROF(0x13BB1C);
void *&SAMP::Debug::pSecondEntity = *(void **)SAMP_ADDROF(0x13BB20);
