...
int SAMP::CInput::MsgProc(unsigned int uMsg, unsigned int wParam, long lParam) {
	return ((int(__thiscall *)(CInput *, unsigned int, unsigned int, long))SAMP_ADDROF(0x65B30))(this, uMsg, wParam, lParam);
}
...
void SAMP::CInput::SendCommand(const char *pText) {
	((void(__thiscall *)(CInput *, const char *))SAMP_ADDROF(0x65C60))(this, pText);
}
